...
class LocalStorage {
  ...
  Future<void> saveJwtToken(String jwtToken) async {
    ...
    await prefs.setString(jwtTokenKey, jsonEncode(jwtToken));
    // await prefs.setString(jwtTokenKey, jsonEncode(data));
  }

  /// Get the wird data from SharedPreferences
  Future<String> getJwtToken() async {
    final prefs = await _prefs;
    final data = prefs.getString(jwtTokenKey);
    if (data == null) return '';
